...
//            JOptionPane.showMessageDialog(null, ex.getMessage(), error, JOptionPane.WARNING_MESSAGE);
    ...
    public void setCredentials(final String user, final String password)
    {
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
            	apph.setCredentials(user, password);
            	return null;
            }
        });
    }
    ...
    public void setRemoteProviderParameters(final String userName, final String password, final String domain, final String providerURL)
    {
        // We grant to JavaScript the same privileges as the core applet
        ...
        AccessController.doPrivileged(new PrivilegedAction<Object>()
        {
            public Object run()
            {
            	apph.setAddRemoteProviderParameter(userName, password, domain, providerURL);
            	return null;
            }
        });
    }
