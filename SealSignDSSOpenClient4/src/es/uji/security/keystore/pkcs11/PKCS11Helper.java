...
public class PKCS11Helper
{
    ...
    public X509Certificate[] getCertificates() throws PKCS11HelperException
    {
    	...
    	for (Enumeration<X509Certificate> e = certificates.elements(); e.hasMoreElements();)
        {
    		log.debug("Found certificate whith alias " + ((X509Certificate)e.nextElement()).getSubjectDN().getName());
        }
